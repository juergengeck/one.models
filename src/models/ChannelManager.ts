...
type ChannelInfoCacheEntry = {
    ...
    mergedHandlers: ((v?: unknown) => void)[]; // Handlers that are notified if the version was merged
};
    ...
    private static async *mergeIteratorMostCurrent(
        ...
        while (true) {
            ...
            if (onlyDifferentElements) {
                // Same get the indices of the currentValues that are equal to the most current element
