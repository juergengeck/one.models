                    ...
                    if (rebuiltHead !== channelInfosToMerge[channelInfosToMerge.length - 1].head) {
                        ...
                        if (newVersionIndex == lastVersionToMerge + 1) {
                            ...
                            this.channelInfoCache.set(channelIdHash, {
                                readVersion: newVersion.obj,
                                readVersionIndex: newVersionIndex,
                                latestMergedVersionIndex: newVersionIndex
                            });
                            ...
                            this.channelInfoCache.set(channelIdHash, {
                                readVersion: newVersion.obj,
                                readVersionIndex: newVersionIndex,
                                latestMergedVersionIndex: lastVersionToMerge
                            });
                        ...
                        this.channelInfoCache.set(channelIdHash, {
                            readVersion: channelInfosToMerge[channelInfosToMerge.length - 1],
                            readVersionIndex: lastVersionToMerge,
                            latestMergedVersionIndex: lastVersionToMerge
                        });
