...
export default class ChannelManager extends EventEmitter {
    ...
    /**
     * Sets the default channel owner that is used when none is specified at certani commands
     * like postToChannel
     *
     * TODO: change the name, so that it reflects better what is done to e.g. setDefaultOwner
     *
     * @param {SHA256IdHash<Person>} id
     */
    public setPersonId(id: SHA256IdHash<Person>): void {
        this.personId = id;
    }
